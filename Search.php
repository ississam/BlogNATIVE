        ...
        <div class="container  " style="margin-top:80px;">
            ...
            <div class="row justify-content-center">
                ...
                if ( isset($_POST['search']) ){
                    ...
                    $search=test_input($_POST['search']) ;//htmlent  ities?

                }  
                $search = $conn->prepare("SELECT * FROM article  WHERE title LIKE '%$search%' OR contenu LIKE '%$search%' ");
                $search->execute();
                $result = $search->setFetchMode(PDO::FETCH_ASSOC);

                foreach ($search->fetchAll() as $key => $article) : ?>
