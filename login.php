...
<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form method="POST" action="login.php" enctype="multipart/form-data" class="login100-form validate-form">
					...
					<input type="submit" name="submit-login" value="Login" class="login100-form-btn">
